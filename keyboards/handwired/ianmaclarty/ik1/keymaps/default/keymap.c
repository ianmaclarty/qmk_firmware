...
KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                               KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    FN,
                        KC_LALT,    KC_LGUI,    KC_LCTL,    TAB1,       KC_SPC,     BSSFT,      ENT2,       FN,         KC_LBRC,    KC_RBRC
),
...
_______,    _______,    _______,    KC_LPRN,    KC_RPRN,    _______,                            _______,    KC_MUTE,    KC_VOLD,    KC_VOLU,    _______,    _______,
