...
[LBASE] = LAYOUT_split_4x6_5(
_______,    KC_1,       KC_2,       KC_3,       KC_4,       KC_5,                               KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       _______,
KC_ESC,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,                               KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_DEL,
KC_LALT,    KC_A,       KC_S,       KC_D,       KC_F,       KC_G,                               KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,
KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                               KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RGUI,
                        DF(LFLIP),  _______,    KC_LCTL,    TABNUM,     KC_SPC,     BSSFT,      ENTNAV,     FN,         _______,    _______
),

[LFLIP] = LAYOUT_split_4x6_5(
_______,    KC_1,       KC_2,       KC_3,       KC_4,       KC_5,                              KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       _______,
KC_ESC,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,                              KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_DEL,
KC_TAB,     KC_A,       KC_S,       KC_D,       KC_F,       KC_G,                              KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_QUOT,
KC_SPC,     KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                              KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_ENT,
                        DF(LBASE),  _______,    KC_LALT,    KC_LCTL,    KC_LSFT,    KC_SPC,    BSNAV,      KC_RGUI,    _______,    _______
),

[LNUM] = LAYOUT_split_4x6_5(
...
_______,    KC_EXLM,    KC_AT,      KC_HASH,    KC_DLR,     KC_TILD,                            KC_DOT,     KC_1,       KC_2,       KC_3,       KC_BSLS,    _______,
                        _______,    _______,    _______,    _______,    _______,    _______,    KC_0,       KC_DOT,     _______,    _______
),


[LNAV] = LAYOUT_split_4x6_5(
_______,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,                              KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     _______,
...
_______,    KC_UNDS,    KC_PLUS,    KC_LPRN,    KC_RPRN,    KC_BSLS,                            KC_INS,     KC_MUTE,    KC_VOLD,    KC_VOLU,    _______,    _______,
                        _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______
),
                             
[LFN] = LAYOUT_split_4x6_5(
_______,    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,                              KC_F6,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     _______,
