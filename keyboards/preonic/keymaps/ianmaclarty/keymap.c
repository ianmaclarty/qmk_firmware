...
[_BASE] = LAYOUT_preonic_grid( \
  ...
  LT_FN,   KC_LALT, KC_LGUI, LT_NUM,  LT_NUM,  KC_SPC,  KC_SPC,  LT_CAPS, LT_CAPS, KC_LEFT, KC_DOWN, KC_RIGHT
),
...
[_FUNCTION] = LAYOUT_preonic_grid(
    TG(_RESET), TRNS,       TRNS,       TRNS,       TRNS,       TRNS,       TRNS,       KC_KP_7,    KC_KP_8,    KC_KP_9,    TRNS,       KC_PGUP,
    TRNS,       TRNS,       TRNS,       TRNS,       TRNS,       TRNS,       TRNS,       KC_KP_4,    KC_KP_5,    KC_KP_6,    KC_PSCREEN, KC_PGDOWN,
